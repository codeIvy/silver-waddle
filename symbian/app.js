(function(){
  ...
  function setChrome(name,leftText="Options",rightText="Back"){title.textContent=name;left.textContent=leftText;right.textContent=rightText}
  ...
  function home(){
    screen="home";setChrome("Menu","Options","Exit");
    view.innerHTML=`<div class="home"><div class="home-banner"><div class="home-time">23:48</div><div class="home-date">Sat 11.10.2003 · ${esc(data.owner)}</div></div><div class="grid"><button class="app-icon" data-app="mail"><span class="glyph mail-glyph">✉</span><span>Messaging</span></button><button class="app-icon" data-app="maps"><span class="glyph maps-glyph">⌖</span><span>Maps</span></button><button class="app-icon disabled" data-app="disabled"><span class="glyph">☏</span><span>Contacts</span></button><button class="app-icon disabled" data-app="disabled"><span class="glyph">▣</span><span>Gallery</span></button><button class="app-icon disabled" data-app="disabled"><span class="glyph">♬</span><span>RealPlayer</span></button><button class="app-icon disabled" data-app="disabled"><span class="glyph">⚙</span><span>Tools</span></button></div></div>`;
  }
  function inbox(){
    screen="inbox";setChrome("Inbox","Options","Back");
  ...
  function message(id){
    ...
    mail.unread=false;screen="message";setChrome("Message","Options","Back");
  ...
  function maps(){
    ...
    screen="maps";setChrome("Maps","","Back");
